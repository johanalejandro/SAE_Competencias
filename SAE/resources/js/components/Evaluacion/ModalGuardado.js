...
export default class ModalGuardado extends Component {
              ...
              onClick={ e => e.stopPropagation() }>
                  <div className="modal-flex-sae">
                    ...
                    <div className="modal-body text-justify">
                        Ha guardado los datos de evaluación del {tipo} con éxito
                    </div>
                
                    <div className="modal-footer">
                            <button type="button" className="btn btn-secondary bg-success mb-2 w-20" onClick={(e)=>{this.closeModal(e,true)}}>OK</button>
                    </div>
                </div>
            </div>
